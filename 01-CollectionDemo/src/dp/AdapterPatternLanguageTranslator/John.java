...
public class John implements ITarget {
	...
	static {
		...
		frenchEnglishMap.put("Je suis tr�s bien", "I am fine");
	...
	public String translateAndTellToOtherPerson(String words, String convertToWhichLanguage) {
		if (convertToWhichLanguage.equalsIgnoreCase("English")) {
			...
			System.out.println(
					"\nJohn Converted \"" + words + " \" to \"" + englishWords + " and send the question to David");
			...
			System.out.println("John Converted " + "\"" + englishWordsReply + "\"" + " to " + "\"" + frenchConverted
					+ "\"" + " and send back to Rohit\n");
...

		{
			...
			System.out.println(
					"\nJohn Converted \"" + words + " \" to \"" + frenchWords + " and send the question to Rohit");
			...
			System.out.println("John Converted " + "\"" + frenchWordsReply + "\"" + " to " + "\"" + englishConverted
					+ "\"" + " and send back to David\n");
