	...
	public static void main(String[] args) {
		...
		Collections.sort(countryList, new Comparator<Country>() {
			...
			public int compare(Country o1, Country o2) {
				...
				System.out.println("Compare method  has been called in order to arrange the country objects in "
						+ " ascending order based on Country Name for " + o1.toString() + " and " + o2.toString());
