package com.java.demo.oop.models;

public class CarDemo {
	public static void main(String[] args) {

		/*
		 * Create maruthiAltok10 car object and set the properties
		 */
		...
		/*
		 * Create swift car object and set the properties
		 */
		Car swift = new Car();
		...
		/*
		 * Create maruthiAlto800 car object and set the properties
		 */
