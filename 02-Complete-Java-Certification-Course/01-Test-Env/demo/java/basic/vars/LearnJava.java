...
public class LearnJava {
	...
	public static void main(String[] args) {
		...
		// Bitwise operators!
		/*
		 * ~ Unary bitwise complement << Signed left shift >> Signed/Arithmetic right
		 * shift >>> Unsigned/Logical right shift & Bitwise AND ^ Bitwise exclusive OR |
		...
		/*
		 * private static final Set<String> COUNTRIES_SET = new HashSet<String>();
		 * static { COUNTRIES_SET.add("DENMARK"); COUNTRIES_SET.add("SWEDEN");
		 * COUNTRIES_SET.add("FINLAND"); }
		 * 
		 * // But there's a nifty way to achieve the same thing in an // easier way, by
		 * using something that is called Double Brace // Initialization. private static
		 * final Set<String> COUNTRIES = new HashSet<String>() {{ add("DENMARK");
		 * add("SWEDEN"); add("FINLAND"); }}
		 */
